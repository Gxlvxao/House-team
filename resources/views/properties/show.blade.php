                    ...
                    <div class="bg-ht-navy text-white p-8 rounded-[2rem] shadow-2xl border border-white/10 relative overflow-hidden">
                        ...
                        @if($property->consultant)
                            ...
                            <div class="relative z-10 bg-white/5 p-6 rounded-2xl border border-white/10 mb-6">
                                ...
                                <div class="space-y-3">
                                    <a href="{{ route('contact') }}" class="block w-full bg-white text-ht-navy font-black uppercase tracking-widest py-3 text-xs rounded-xl hover:bg-ht-accent hover:text-white transition-all text-center shadow-lg">
                                        Agendar Visita
                                    </a>
                                    @if($property->consultant->phone)
                                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $property->consultant->phone) }}?text=Olá {{ $property->consultant->name }}, vi o imóvel {{ $property->title }} no site." target="_blank" class="flex items-center justify-center gap-2 w-full border border-green-500 text-green-400 font-bold uppercase tracking-widest py-3 text-xs rounded-xl hover:bg-green-500 hover:text-white transition-all">
