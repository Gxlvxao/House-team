        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div class="md:col-span-1">
                ...
                <ul class="space-y-4">
                    <li class="flex items-start gap-3 text-slate-300">
                        <svg class="w-5 h-5 text-ht-blue mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                        <a href="tel:+351923224551" class="hover:text-white transition-colors">+351 923 224 551</a>
                    </li>
                    <li class="flex items-start gap-3 text-slate-300">
                        <svg class="w-5 h-5 text-ht-blue mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                    ...
                    {{-- Endereço (Deixei comentado caso queira ativar depois) --}}
                    {{-- 
                    <li class="flex items-start gap-3 text-slate-300">
            ...
            <div class="md:col-span-1">
                ...
                <ul class="space-y-3 text-slate-300 text-sm font-medium">
                    <li><a href="{{ route('home') }}" class="hover:text-ht-blue transition-colors">Início</a></li>
                    <li><a href="{{ route('portfolio') }}" class="hover:text-ht-blue transition-colors">Imóveis</a></li>
                    <li><a href="{{ route('contact') }}" class="hover:text-ht-blue transition-colors">Contactos</a></li>
                    <li><a href="{{ route('tools.gains') }}" class="hover:text-ht-blue transition-colors">Simulador Mais-Valias</a></li>
                </ul>
            </div>
            ...
            <div class="md:col-span-1">
                ...
                <div class="flex gap-4">
                    <a href="#" target="_blank" class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-white hover:bg-ht-blue hover:scale-110 transition-all">
